...
\end{align}
where $n$ is the sample size. This coefficient takes values in $[0,1)$, equals zero under independence, and can be interpreted as a normalized measure of association strength, analogous to $R^2$ or $\eta^2$, but derived from likelihood comparisons.
