...
covering social attitudes, behaviours, and socio-demographic characteristics;
...
$W = (X,Y)$ with $K = I \times J$ categories. The modelling strategy is based on
...
\begin{figure}[H]
\centering
\includegraphics[width=0.96\linewidth,height=0.24\textheight,keepaspectratio]{section3.3_unconditional_pairplot_netusoft_facntr}
\par\smallskip
\small Unconditional pair plot.
...
the observed counts $O_{ij}$ inside cells, it colours cells according to the sign
