...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth,trim=0 16 0 17,clip]{section3.1_unconditional_pairplot_pplfair_trstplt.jpg}
\par\smallskip
\small Unconditional pair plot.

\medskip

\includegraphics[width=0.92\linewidth,trim=33 0 33 0,clip]{section3.1_conditional_pairplot_pplfair_trstplt_agea.jpg}
\par\smallskip
